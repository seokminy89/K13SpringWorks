...
<div class="container">
	...
	<li>
		...
		&nbsp;&nbsp;&nbsp;
		<a href="./resources/found.html" target="_blank">HTML 파일사용O</a>
		&nbsp;&nbsp;&nbsp;
		<a href="./static/found.html" target="_blank">resources 대신 별칭 사용할 수 있음.</a>
	</li>
	<!-- 
	webapp하위에서는 JSP파일은 사용할 수 있다.
	jsp 이므로 스크립틀릿이나 클래스 임포트 등도 모두 가능하다. 
	-->
	<li>
		<a href="./randomNum.jsp">jsp파일 사용하기</a>
	</li>
	<li>
