...
public class FormController {
	...
	/*
	폼값 받기2]  @RequestMapping 어노테이션으로 폼값 받기
		파라미터 형식으로 아래와 같이 사용한다.
		이와 같이하면 해당 메서드 내에서 변수명을 그대로 사용할 수 있다.
	*/
	...
	public String joinMember(Model model,
		...
		//DTO 객체를 Model객체에 저장한 후 View 호출
	...
	조건2 : 커맨드 객체를 사용할대는 클래스명 앞글자를 소문자로 바꾼
		형태의 매개변수를 사용해야 한다. EX) MemberDTO -> memberDTO
	조건3 : 커맨드객체를 만들때 파라미터의 갯수는 달라도 상관없으나
		파라미터명과 멤버변수명은 동일해야하고 이에 해당하는
